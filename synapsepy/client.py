...
class Client:
    ...
    def __init__(
        ...
        self.http = HttpClient(
            ...
            if devmode
            else "https://api.synapsefi.com/v3.1",
            logging=logging,
        )
    ...
    def trade_market_data(self, ticker):
        ...
        response = self.http.get(path, ticker=ticker)
        return response

    def locate_atms(
        self, zip=None, lat=None, lon=None, rad=None, page=None, per_page=None
    ):
        ...
        response = self.http.get(
            path, zip=zip, lat=lat, lon=lon, radius=rad, page=page, per_page=per_page
        )
        return response
    ...
    def get_all_users(
        self, query=None, page=None, per_page=None, show_refresh_tokens=None
    ):
    ...
    def get_all_nodes(self, page=None, per_page=None, type=None):
        ...
        path = paths["nodes"]
        response = self.http.get(path, page=page, per_page=per_page, type=type)
